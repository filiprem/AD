...
KWESTIA_ACTION={
  ...
  "NEGATIVE_PRIORITY_VOTE":"Siła priorytetu w realizacjii była mniejsza od 0"
};
...
NOTIFICATION_TYPE = {
    HONOROWY_INVITATION: "Zaproszenie do Aplikowania na stanowisko Członka Honrowego",
    NEW_ISSUE: "Pojawienie się nowej Kwestii",//itd,
    ISSUE_NO_PRIORITY:"Brak aktywności w Kwestii",
    MESSAGE_FROM_USER:"Wiadomość od użytkownika",
    LOOBBING_MESSAGE:"Lobbowanie kwestii",
    APPLICATION_CONFIRMATION: "Przyjęcie wniosku aplikacyjnego",//doradca->zwycz,
    APPLICATION_ACCEPTED: "Przyjęcie wniosku aplikacyjnego",//doradca->zwycz,doradca->hon
    APPLICATION_REJECTED: "Odrzucenie wniosku aplikacyjnego",//doradca->zwycz,dora->hon(na etapie np realziacji)
};
