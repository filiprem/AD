...
Router.map(function() {
    ...
    this.route('proceduraWstrzymania', {
        ...
        data: function() {
            return KwestiaSuspension.findOne({_id:this.params._id}) ;
        },
        onBeforeAction: function() {
            if (! Meteor.user()) {
                this.render('accessDenied');
                ...
                this.subscribe("kwestiaSuspension",this.params._id);
                this.subscribe('kwestiaSuspensionPosts',this.params._id);
    ...
    this.route('informacjeKwestia', {
        ...
        onBeforeAction: function() {
            if (! Meteor.user()) {
                ...
                this.subscribe("kwestiaSuspensionBykwestiaId",this.params._id);
                this.next();
            }
        }
    });
