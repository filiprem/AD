Router.configure({
    ...
    waitOn: function () {
        return [
            ...
            //TODO czy ponizsze subskrypcje sa potrzebne?
...
Router.map(function () {
    ...
    this.route('activate_account', {
        ...
        waitOn: function () {
            //this.subscribe('usersUsernames');//TODO
            this.subscribe("usersType");
    ...
    this.route('register_form', {
        ...
        waitOn: function () {
            ...
            this.subscribe("usersEmails");//TODO
            this.subscribe("zespolyRealizacyjne");
            //this.subscribe("usersUsernames");//TODO
            this.subscribe("usersType")
        }
    ...
    this.route('doradca_form', {
        ...
        waitOn: function () {
            return [
                this.subscribe("tematy"),
                this.subscribe("rodzaje"),
                this.subscribe("usersType"),                this.subscribe("parametr"),
                this.subscribe("zespolyRealizacyjne"),
                this.subscribe("zespolyRealizacyjneDraft"),
                this.subscribe("kwestie")
            ]
    ...
    this.route('sendMessage', {
        ...
        waitOn: function () {
            this.subscribe("userTypeAndNames", this.params._id);
            this.subscribe("notificationsNotRead",Meteor.userId());
        }
    });
